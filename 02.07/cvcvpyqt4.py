...
class TrafficWeak(QMainWindow):
    def __init__(self):
        ...
        self.signFiles=[['02.07/child.png','어린이'],['02.07/elder.png','노인'],['02.07/disabled.png','장애인']]	# 표지판 모델 영상
    ...
    def recognitionFunction(self):
        if self.roadImg is None: 
            ...
            if len(GM[best])<4:	# 최선의 번호판이 매칭 쌍 4개 미만이면 실패
                ...
                cv2.drawMatches(self.signImgs[best],sign_kp,self.roadImg,road_kp,good_match,img_match,flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
